...
public final class standard extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "doclet.Invalid_URL", "invalid URL: {0}" },
            ...
            { "doclet.extSpec.spec.has.multiple.titles", "{1} different titles given in @spec tags for the external specification at {0}" },
            { "doclet.extSpec.title.for.multiple.specs", "The title \"{0}\" is used for {1} different external specifications in @spec tags" },
            { "doclet.extSpec.title.url", "title: \"{0}\", url: {1}" },
            { "doclet.extSpec.url.title", "url: {0}, title: \"{1}\"" },
            ...
            { "doclet.help.externalSpecifications.body", "The {0} page lists references to external specifications." },
            ...
            { "doclet.help.search.intro", "You can search for definitions of modules, packages, types, fields, methods, system properties and other terms defined in the API. These items can be searched using part or all of the name, optionally using \"camelCase\" abbreviations, or multiple search terms separated by whitespace. Some examples:" },
            ...
            { "doclet.search.browser_info", "The URL template below may be used to configure this page as a search engine in browsers that support this feature. It has been tested to work in Google Chrome and Mozilla Firefox. Note that other browsers may not support this feature or require a different URL format." },
            { "doclet.search.help_page_info", "The {0} provides an introduction to the scope and syntax of JavaDoc search." },
            { "doclet.search.help_page_link", "help page" },
            { "doclet.search.keyboard_info", "You can use the <ctrl> or <cmd> keys in combination with the left and right arrow keys to switch between result tabs in this page." },
            ...
            { "doclet.usage.add-script.description", "Add a script file to the generated documentation" },
            { "doclet.usage.add-script.parameters", "<file>" },
            { "doclet.usage.add-stylesheet.description", "Add a stylesheet file to the generated documentation" },
            ...
            { "doclet.usage.link-modularity-mismatch.description", "Report external documentation with wrong modularity with either\na warning or informational message. The default behaviour is to\nreport a warning." },
            ...
            { "doclet.usage.snippet-path.description", "The path for external snippets" },
            ...
            { "doclet.usage.spec-base-url.description", "Specify a base URL for relative URLs in @spec tags" },

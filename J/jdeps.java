...
public final class jdeps extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "main.opt.ignore-missing-deps", "  --ignore-missing-deps         Ignore missing dependences." },
            ...
            { "main.opt.missing-deps", "  --missing-deps                Finds missing dependences.  This option\n                                cannot be used with -p, -e and -s options." },
            ...
            { "main.opt.no-recursive", "  --no-recursive                Do not recursively traverse dependences." },

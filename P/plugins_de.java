...
public final class plugins_de extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compact-cp.argument", "<Ressourcenpfade>" },
            { "compact-cp.description", "Gemeinsame Verwendung von Zeichenfolgen im Konstantenpool.\nStandardm\u00E4\u00DFig werden alle Ressourcen komprimiert. Sie k\u00F6nnen ausdr\u00FCcken, dass\nein Ressourcenset komprimiert oder nicht komprimiert werden soll (mit ^ f\u00FCr Negierung)." },
            { "compact-cp.usage", " --compact-cp <Ressourcenpfade>\n                            Gemeinsame Verwendung von Zeichenfolgen im Konstantenpool.\n                            Standardm\u00E4\u00DFig werden alle Ressourcen komprimiert.\n                            Sie k\u00F6nnen ausdr\u00FCcken, dass ein Ressourcenset komprimiert\n                            oder nicht komprimiert werden soll (mit ^ f\u00FCr Negierung)." },
            { "compress.argument", "<0|1|2>[:filter=<Musterliste>]" },
            { "compress.description", "Komprimiert alle Ressourcen im Ausgabeimage.\nEbene 0: Keine Komprimierung\nEbene 1: Gemeinsame Verwendung konstanter Zeichenfolgen\nEbene 2: ZIP.\nEin optionaler <Musterliste>-Filter kann angegeben werden, um das Muster der\neinzuschlie\u00DFenden Dateien aufzulisten." },
            { "compress.usage", "  --compress <0|1|2>[:filter=<Musterliste>]\n                            Komprimiert alle Ressourcen im Ausgabeimage.\n                            Ebene 0: Keine Komprimierung\n                            Ebene 1: Gemeinsame Verwendung konstanter Zeichenfolgen\n                            Ebene 2: ZIP.\n                            Ein optionaler <Musterliste>-Filter kann angegeben\n                            werden, um das Muster der einzuschlie\u00DFenden\n                            Dateien aufzulisten." },
            ...
            { "plugin.opt.compress", "  -c, --compress=<0|1|2>                Aktiviert die Komprimierung von Ressourcen:\n                                          Ebene 0: Keine Komprimierung\n                                          Ebene 1: Gemeinsame Verwendung konstanter Zeichenfolgen\n                                          Ebene 2: ZIP" },
            ...
            { "plugin.opt.post-process-path", "      --post-process-path <Imagedatei>   F\u00FChrt Nachverarbeitung eines vorhandenen Images aus" },

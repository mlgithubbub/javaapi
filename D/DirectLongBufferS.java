...

{
    ...
    public long get() {
        try {
            return (Bits.swap(SCOPED_MEMORY_ACCESS.getLong(session(), null, ix(nextGetIndex()))));
        } finally {
    ...
    public long get(int i) {
        try {
            return (Bits.swap(SCOPED_MEMORY_ACCESS.getLong(session(), null, ix(checkIndex(i)))));
        } finally {
            Reference.reachabilityFence(this);
        }
    }
    ...
    public LongBuffer put(long x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putLong(session(), null, ix(nextPutIndex()), Bits.swap((x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;
    ...
    public LongBuffer put(int i, long x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putLong(session(), null, ix(checkIndex(i)), Bits.swap((x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;

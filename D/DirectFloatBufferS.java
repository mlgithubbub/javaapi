...

{
    ...
    public float get() {
        try {
            return Float.intBitsToFloat(Bits.swap(SCOPED_MEMORY_ACCESS.getInt(session(), null, ix(nextGetIndex()))));
        } finally {
    ...
    public float get(int i) {
        try {
            return Float.intBitsToFloat(Bits.swap(SCOPED_MEMORY_ACCESS.getInt(session(), null, ix(checkIndex(i)))));
        } finally {
            Reference.reachabilityFence(this);
        }
    }
    ...
    public FloatBuffer put(float x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putInt(session(), null, ix(nextPutIndex()), Bits.swap(Float.floatToRawIntBits(x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;
    ...
    public FloatBuffer put(int i, float x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putInt(session(), null, ix(checkIndex(i)), Bits.swap(Float.floatToRawIntBits(x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;

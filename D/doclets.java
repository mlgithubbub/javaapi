...
public final class doclets extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "doclet.annotationtype", "annotation type" },
            { "doclet.annotationtypes", "annotation types" },
            { "doclet.cannot_use_snippet_path", "Cannot use ''--snippet-path'' option with the given file manager: {0}" },
            { "doclet.class", "class" },
            ...
            { "doclet.error_setting_snippet_path", "Error setting snippet path {0}: {1}" },
            ...
            { "doclet.snippet.contents.ambiguity.external", "@snippet specifies multiple external contents, which is ambiguous" },
            { "doclet.snippet.contents.mismatch", "contents mismatch:\n{0}" },
            { "doclet.snippet.contents.none", "@snippet does not specify contents" },
            { "doclet.snippet.markup", "snippet markup: {0}" },
            { "doclet.snippet.markup.attribute.absent", "missing attribute \"{0}\"" },
            { "doclet.snippet.markup.attribute.simultaneous.use", "attributes \"{0}\" and \"{1}\" used simultaneously" },
            { "doclet.snippet.markup.attribute.unexpected", "unexpected attribute" },
            { "doclet.snippet.markup.attribute.value.invalid", "invalid attribute value" },
            { "doclet.snippet.markup.attribute.value.unterminated", "unterminated attribute value" },
            { "doclet.snippet.markup.regex.invalid", "invalid regex" },
            { "doclet.snippet.markup.region.duplicated", "duplicated region" },
            { "doclet.snippet.markup.region.none", "no region to end" },
            { "doclet.snippet.markup.region.unpaired", "unpaired region" },
            { "doclet.snippet.markup.spurious", "spurious markup" },
            { "doclet.snippet.markup.tag.non.existent.lines", "tag refers to non-existent lines" },
            { "doclet.snippet.region.not_found", "region not found: \"{0}\"" },
            ...
            { "doclet.tag.attribute.repeated", "repeated attribute: \"{0}\"" },
            { "doclet.tag.attribute.value.illegal", "illegal value for attribute \"{0}\": \"{1}\"" },
            { "doclet.tag.attribute.value.missing", "missing value for attribute \"{0}\"" },
            ...
            { "doclet.throwsInheritDocUnsupported", "@inheritDoc is not supported for exception-type type parameters that are not declared by a method; document such exception types directly" },

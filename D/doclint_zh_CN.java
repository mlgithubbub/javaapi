...
public final class doclint_zh_CN extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "dc.attr.img.border.not.number", "\u5C5E\u6027 \"border\" \u7684\u503C\u65E0\u6548\uFF1A\"{0}\"" },
            { "dc.attr.img.border.not.valid", "\u56FE\u50CF\u7684\u5C5E\u6027 \"border\" \u53EA\u63A5\u53D7 \"0\"\uFF1A{0}" },
            ...
            { "dc.attr.table.border.not.number", "\u5C5E\u6027 \"border\" \u7684\u503C\u65E0\u6548\uFF1A\"{0}\"" },
            { "dc.attr.table.border.not.valid", "\u8868\u7684\u5C5E\u6027 \"border\" \u53EA\u63A5\u53D7 \"\" \u6216 \"1\"\uFF1A{0}" },
            ...
            { "dc.no.summary.or.caption.for.table", "\u8868\u6CA1\u6709\u6807\u9898" },
            { "dc.param.name.not.found", "@param name \u672A\u627E\u5230" },
            { "dc.ref.in.missing.module", "\u627E\u4E0D\u5230\u5F15\u7528\u7684\u6A21\u5757\uFF1A{0}" },
            { "dc.ref.not.found", "\u627E\u4E0D\u5230\u5F15\u7528" },
            { "dc.return.not.first", "'{@return} \u4E0D\u5728\u8BF4\u660E\u7684\u5F00\u5934" },

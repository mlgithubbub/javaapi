...
public class CLDRBaseLocaleDataMetaInfo implements LocaleDataMetaInfo {
    ...
    private static final Map<String, String> languageAliasMap = HashMap.newHashMap(208);
    ...
    static {
        ...
        parentLocalesMap.put(Locale.forLanguageTag("en-001"),
            new String[] {
                ...
                "en-BW", "en-BZ", "en-CC", "en-CK", "en-CM", "en-CX", "en-CY", "en-DG", 
                "en-DM", "en-ER", "en-FJ", "en-FK", "en-FM", "en-GB", "en-GD", "en-GG", 
                "en-GH", "en-GI", "en-GM", "en-GY", "en-HK", "en-IE", "en-IL", "en-IM", 
    ...
    private static class TZCanonicalIDMapHolder {
        static final Map<String, String> tzCanonicalIDMap = HashMap.newHashMap(461);
        static {
